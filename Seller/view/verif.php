            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
						<form name = 'verification' method = "POST" action = "verif2.php">
							<table class="table">
								<thead>
									<tr>
										<th>No</th>
								...
								<tbody>
									<?php
										...
										$idSeller = $_COOKIE['idSeller'];
										$counter = 0;
										$result = getTransaksiBasedIdSeller($con, $idSeller);
										while($row = mysqli_fetch_array($result)){
											...
											$namaBuyer = "";
											$sql2 = "SELECT a.firstName, a.lastName FROM a users, b buyer WHERE b.idBuyer = " . $idBuyer . " AND a.idUser = b.idUser";
											$result2 = mysqli_query($con, $sql2);
											while($row2 = mysqli_fetch_array($result2)){
												$namaBuyer = $row2['firstName'] . " " . $row2['lastName'];
											}
											echo "
											<tr>
												<td class = 'name-pr'>
												...
												<td class = 'add-pr'>
													<input type = 'submit' name = 'decline' value = 'Decline' valss = 'btn btn-secondary'>
												</td>
											</tr>
