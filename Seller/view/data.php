        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
					...
					<form name='blabla' method='post' action = 'add.php'>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Images</th>
                            ...
                            <tbody>
								<?php
									...
									$result = getBarangBasedIdStore($con, $idStore);
									while($row = mysqli_fetch_array($result)){
										...
										<tr>
											<td class = 'thumbnail-img'>
												<img class = 'img-fluid' src = 'images/" . $gambar . "' alt = '' />
											</td>
											<td class = 'name-pr'>
												<b>" . $namaBarang . "</b>
											</td>
											...
											<td class = 'add-pr'>
												<input type = 'submit' class = 'btn btn-primary' name = 'removeBarang' value = 'Remove'>
											</td>
										</tr>
