                        ...
                        <table class="table">
                            ...
                            <tbody>
								<?php
									...
									$total = 0;
									$result = getTransaksiInformation($con, $idTransaksi);
									while($row = mysqli_fetch_array($result)){
										$gambarBarang = "images/" . $row['gambarBarang'];
										$namaBarang = $row['namaBarang'];
										$jumlahBarang = $row['qytBarang'];
										$totalHarga = $row['totalHarga'];
										$total = $total + $totalHarga;
										echo "
										<tr>
											<td class = 'thumbnail-img'>
												<img class = 'img-fluid' src = '" . $gambarBarang . "' alt = '' />
											</td>
											<td class = 'name-pr'>
												<b>" . $namaBarang . "</b>
											</td>
											...
											<td class = 'price-pr'>
												<p>Rp. " . ($hargaBarang * $jumlahBarang) . ",-</p>
											</td>
										</tr>
										";
									}
