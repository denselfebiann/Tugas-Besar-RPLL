                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown active megamenu-fw">
                            <a href="shop.html" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">Product</a>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                    <div class="right-product-box">
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
								...
								<?php
									...
									echo "<p>Showing all " . $counter . " results</p>";
								?>
                        ...
                        <form name = 'barang' action = 'shop-detail.php' method= 'POST'>
                                                    ...
                                                    <div class='col-sm-6 col-md-6 col-lg-4 col-xl-4'>
                                                        <div class='products-single fix'>
                                                            <div class='box-img-hover'>
                                                                ...
                                                                <img src='images/".$gambarBarang."' class='img-fluid' alt='Image'>
                                                                <div class='mask-icon'>
                                                                    <ul>
                                                                        <li><a href='shop-detail.php?idBarang=" . $idBarang . "' data-toggle='tooltip' data-placement='right' title='View'><i class='fas fa-eye'></i></a></li>
