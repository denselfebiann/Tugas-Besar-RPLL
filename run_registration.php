<?php
	...
	if($password != $confirmPassword){
		...
		$sql = "INSERT INTO tabeluser (email, firstName, lastName, password, wrapPay)
				VALUES('" . $email . "', '" . $firstName . "', '" . $lastName . "', '" . $password . "', 0 )
				";
		if(mysqli_query($con, $sql)){
			$sql =  "SELECT idUser FROM tabeluser ORDER BY idUser DESC LIMIT 1;";
			...
			var_dump($id);
			$sql = "INSERT INTO tabelbuyer (idUser, alamat)
					VALUES(" . $id . ", '" . $alamat . "')
					";
			if(mysqli_query($con, $sql)){
